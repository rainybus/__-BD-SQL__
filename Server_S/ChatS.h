...
private:
	...
	bool _entry;			// ¬±¬â¬à¬Ó¬Ö¬â¬Ü¬Ñ ¬Ó¬à¬ê¬Ö¬Õ¬ê¬Ú¬ç = ¬á¬â¬Ú¬ã¬å¬ä¬ã¬ä¬Ó¬å¬ð¬ë¬Ú¬ç
	bool _conn;

	Server _server;			
	string _ip;		    // IP ¬ã¬Ö¬â¬Ó¬Ö¬â
	uint16_t _port;			    // ¬á¬à¬â¬ä ¬ã¬Ö¬â¬Ó¬Ö¬â¬Ñ

	Database _db;			/// ¬°¬Ò¬ì¬Ö¬Ü¬ä ¬¢¬¥
	string _dbHost;		// ¬¡¬Õ¬â¬Ö¬ã ¬¢¬¥
	string _dbUser;		// ¬±¬à¬Ý¬î¬Ù¬à¬Ó¬Ñ¬ä¬Ö¬Ý¬î ¬¢¬¥
	string _dbPass;	// ¬±¬Ñ¬â¬à¬Ý¬î ¬á¬à¬Ý¬î¬Ù¬à¬Ó¬Ñ¬ä¬Ö¬Ý¬ñ ¬¢¬¥
	string _dbName;		// ¬ª¬Þ¬ñ ¬¢¬¥
